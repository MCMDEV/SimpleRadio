...
public class Module {
    ...
    public Module(ResourceLocation identifier) {
        this(identifier, ResourceLocation.tryBuild(identifier.getNamespace(), "module/"+identifier.getPath()));
    }
    public Module(ResourceLocation identifier, Type... types) {
        this(identifier, ResourceLocation.tryBuild(identifier.getNamespace(), "module/"+identifier.getPath()), types);
    }
